...
Usage:
       ...
       python capsnet/twodigitcapsules/mnist_capsulenet.py --epochs 50
       python capsnet/twodigitcapsules/mnist_capsulenet.py --epochs 50 --routings 3
       python capsnet/twodigitcapsules/mnist_capsulenet.py --primary_capsules=32 --number_of_primary_channels=16 --digit_capsules=16
       ... ...
