...
model = resnet_v2(input_shape=mnist.IMAGE_SHAPE, depth=depth)
...
if __name__ == '__main__':
    ...
    model.fit_generator(mnist.get_train_generator_for_cnn(batch_size),
                        steps_per_epoch=mnist.TRAIN_SIZE / batch_size,
                        validation_data=mnist.get_validation_data_for_cnn(),
                        epochs=epochs, verbose=1, workers=4,
                        callbacks=callbacks)

    # Score trained model.
    x_test, y_test = mnist.get_test_data_for_cnn()
