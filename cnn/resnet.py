...
def resnet_v2(input_shape, depth, num_classes=10):
    ...
    outputs = keras.layers.Dense(cifar10.CLASSES,
                                 activation='softmax',
...
model.fit_generator(cifar10.get_train_generator_for_cnn(batch_size),
                    steps_per_epoch= cifar10.TRAIN_SIZE / batch_size,
                    validation_data=cifar10.get_validation_data_for_cnn(),
